...
<html>
	<head lang="en">
		...
		<style type="text/css">
			...
			.main{padding:48px 0 54px;font-size:0;}
			...
			.buttons-left{position:absolute;left:10px;top:15px;font-size:14px;}
			.button i{font-style:normal;color:#fff;}
			.title-center{text-align:center;font-size:16px;line-height:48px;}
			.buttons-right{position:absolute;right:10px;top:10px;}
			...
			.spical2{position:relative; background:#FC6368;border-radius:3px;}
			.spical3{background:#ddd;}
			...
			.tab-nav{font-size:0;background-color:#fff;border-top:1px solid #f4f4f4;}
			.tab-item{display:inline-block; width:50%;text-align:center;padding:5px 0;font-size:13px;color:#7A7A7A;}
			.tab-item .icon{display:block;padding-bottom:3px;color:#6A6A6A;}
		</style>
	</head>
	<body>
			...
			<div class="nav-bar-block">
				<div class="bar-love bar bar-header disable-user-behavior">
					...
					<div class="buttons buttons-right">
						<a href="tel:010-68547797" style="font-size: 23px;" class="button button-clear iconfont icon-phone"></a>
					</div>
				</div>
			</div>
		</div>
		<div class="main">
			...
			<div class="links clearfix">
				...
				<a class="spical2 spical3" href="/wtspz/intoservice/2/${openid}">
					<div>
						<h5 class="has-line">
							陪护
						</h5>
		...
		<div class="tab-nav tabs g_fixed">
			...
			<a href="javascript:alert('开发中..');" class="tab-item"> 
