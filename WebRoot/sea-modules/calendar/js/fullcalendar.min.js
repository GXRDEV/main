...
(function(t, e) {
    ...
    function fe(n, r, a) {
        ...
        function y(t, n) {
            n.click(function(r) {
            	if(window._tims) clearTimeout(window._tims);
            	var _this = this;
            	window._tims = setTimeout(
            			function(){
            				if(window._eventname && window._eventname=='dblclick') return false;
            				n.hasClass("ui-draggable-dragging") || n.hasClass("ui-resizable-resizing") ? e: i("eventClick", _this, t, r)
            			},
            	200);
            });
            n.dblclick(function(r){
            	window._eventname='dblclick';
            	n.hasClass("ui-draggable-dragging") || n.hasClass("ui-resizable-resizing") ? e: i("eventDblClick", this, t, r)
			});
            n.hover(function(e) {
