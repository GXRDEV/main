define(['webuploader','webuploader/webuploadDCIM.css'],function(require,exports,module) {
	var WebUploader = require('webuploader');	
	exports.init = function(ops){
		var _success = ops.success || function(){};
		(function( $ ){
		    // 当domReady的时候开始初始化
		    $(function() {
		        var $wrap = $('#uploader'),
		        ...
		        uploader.on('error', function (code) {
	                ...
	                switch (code) {
	                    ...
	                    case 'Q_EXCEED_SIZE_LIMIT': text = '所有文件总大小超过限制!';
	                        break;
	                    case 'Q_TYPE_DENIED': text = '只支持DCM格式的医学影像图';//文件类型不正确或者是空文件!
	                        break;
	                    default: text = '未知错误!';
	                        break;
	                }
		        ...
		        function updateStatus() {
		            ...
		            if ( state === 'ready' ) {
		                ...
		                if ( stats.uploadFailNum ) {
		                    text = '已成功上传' + stats.successNum+ '张照片至DCIM服务器，'+
