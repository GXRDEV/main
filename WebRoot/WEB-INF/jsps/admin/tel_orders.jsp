	...
	<script>
            ...
            $(document).ready(function () {            	
            	oTable = $('.data-table').DataTable({
                    ...
                    "sAjaxSource": "/system/gaintelorders",
                    "bFilter": true,"bLengthChange": true,"bProcessing": true,   
                    "columns":[
                          		null,null,null,null,null,null,null,null,null,null,null,null,null
                           ],
					"fnCreatedRow": function (nRow, aData, iDataIndex) {
						var path= '/system/teldetail/' + aData[0],_val=aData[10];
						var ops='';
						if(_val.indexOf('待接诊') != -1){	
							ops+='<a href="javascript:void(0);" data-id="'+ aData[0] +'" class="linebtn telclose" close-data="50">取消订单</a>';
						}
						if(_val.indexOf('进行中') != -1){	
							ops+='<a href="javascript:void(0);" data-id="'+ aData[0] +'" class="linebtn telclose" close-data="40">问诊完成</a>';
						}
            	...
            	$('body').delegate('#filteropt a','click',function(){
                	...
                	$.post('/doctor/closetel',{oid:oid,ctype:ctype,utype:"0",uid:"13590"},function(data){
                		oTable.draw(false);
                	});
