	...
	<script>
            ...
            $(document).ready(function () {            	
            	oTable = $('.data-table').DataTable({
                    ...
                    "sAjaxSource": "/system/d2pteldatas",
					...
					"fnCreatedRow": function (nRow, aData, iDataIndex) {
						var opts = '<a href ="/app/main.html#ajax/admin/admin_detail.html?orderId='+aData[0]+'&&orderType=7" class="editbtn linebtn">查看详情</a>';
						if(aData[15]=='待接诊'){
            	...
            	$('body').delegate('#filteropt a','click',function(){
                	...
                	if(confirm("您正在变更订单状态，请确认是否继续操作！")){
                		...
                		$.post('/system/changeOrderStatus',{oid:oid,sval:sval,otype:"7",refuls:refuls},function(data){
                    		oTable.draw(false);
                    	});
                	}
