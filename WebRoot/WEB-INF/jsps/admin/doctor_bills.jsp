		  	...
		  	<div class="row-fluid">
		  		...
		  		<div class="span3">
		  			...
		  			<select name="busitype">
		  				...
		  				<option value="4">视频会诊</option>
		  				<option value="5">图文会诊</option>
		  				<option value="6">图文问诊</option>
		  				<option value="7">电话问诊</option>
		  				<option value="9">快速问诊</option>
		  				<option value="12">团队问诊</option>
		  				<option value="13">送心意</option>
	...
	<script>
            ...
            $(document).ready(function () {            	
            	oTable = $('.data-table').DataTable({
                    ...
                    "sAjaxSource": "/system/gaindocbilldatas",
			...
			function setQuestion(){
				contadion = [
					...
					{ "name": "actions", "value":$('select[name="actions"]').val()},
