					...
					<div class="reportresult section">
						...
						<div class="bodyer form-horizontal">
							<div class="control-group">
								 ...
								 <div class="controls">
								    <span class="readonly">${order.teamName}</span>
								 </div>
							</div>
							<div class="control-group">
								 <label class="control-label">团队log：</label>
								 <div class="controls">
								    <span class="readonly">
                            			<c:if test="${fn:length(order.logoUrl) > 1}">
                                			<img src="${order.logoUrl}" style="width:100px;height:100px;">
                           		 		</c:if>
                           		 	</span>
								 </div>
							</div>
							<div class="control-group">
								 ...
								 <div class="controls">
								    <span class="readonly">${order.profile}</span>
								 </div>
							</div>
						</div>	
					</div>
		...
		<script type="text/javascript">
			$(document).ready(function () {   
				 $('body').delegate('.refund','click',function(){
				 	$.post('/system/refundVip',{oid:'${order.id}',otype:'14'},function(data){
