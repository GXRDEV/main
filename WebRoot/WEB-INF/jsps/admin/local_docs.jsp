	...
	<script>
            ...
            $(document).ready(function () {            	
            	oTable = $('.data-table').DataTable({
                    ...
                    "sAjaxSource": "/system/gainlocaldosc",
                    "bFilter": true,"bLengthChange": true,"bProcessing": true,   
                    "columns":[
                          		{"visible": false},{"visible": false},null,null,null,null,null,null,null,null,null
                    ], 
					"fnCreatedRow": function (nRow, aData, iDataIndex) {
						var opts='';
						if(aData[9]=='否'){
							opts+='<a href="javascript:void(0);" class="testFlag linebtn" did='+aData[0]+'>标记测试</a>';
						}
						if(aData[1]==1){
						...
						opts+='<a href="'+ _burl +'system/docEdit?did='+ aData[0] +'" class="editbtn linebtn">编辑</a>';
						opts+='<a href="'+ _burl +'system/doctorDtailList?docId='+ aData[0] +'" class="editbtn linebtn">详情</a>';
            	...
            	$('body').delegate('#filteropt a','click',function(){
                	...
                	if(confirm("标记测试后将不会显示！")){
                		...
                		$.post('/system/testFlag',{did:did},function(data){
                    		oTable.page('first').draw(false);
                    	});
                	}
