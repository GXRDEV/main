					...
					<div class="reportresult section">
						...
						<div class="bodyer form-horizontal">
							<div class="control-group">
								 ...
								 <div class="controls">
								    <span class="readonly">${dteam.teamName}</span>
								 </div>
							</div>
							<div class="control-group">
								 <label class="control-label">团队负责人：</label>
								 <div class="controls">
								    <span class="readonly">${dteam.docName}</span>
								 </div>
							</div>
							<div class="control-group">
								 <label class="control-label">负责人医院：</label>
								 <div class="controls">
								    <span class="readonly">${dteam.hosName}</span>
								 </div>
							</div>
							<div class="control-group">
								 <label class="control-label">负责人科室：</label>
								 <div class="controls">
								    <span class="readonly">${dteam.depName}</span>
								 </div>
							</div>
						</div>	
					</div>
					<div class="reportresult section">
						...
						<div class="bodyer form-horizontal">
							<div class="control-group">
								 ...
								 <div class="controls">
								    <span class="readonly">${order.consultationResult}</span>
								 </div>
							</div>
						</div>	
					</div>
			...
			seajs.use('view/admin/order',function(controller){
			 ...
			 $(document).ready(function () { 
				 $('body').delegate('.closetw','click',function(){
		            	...
		            	$.post('/system/refund',{oid:'${order.id}',otype:'12'},function(data){
