	...
	<script>
            ...
            $(document).ready(function () {            	
            	oTable = $('.data-table').DataTable({
                    ...
                    "sAjaxSource": "/hospital/gainVedioOrderDatas",
                    "bFilter": true,"bLengthChange": true,"bProcessing": true,     
					"fnCreatedRow": function (nRow, aData, iDataIndex) {
						var opts='';
					 	opts+='<a href="/app/main.html#ajax/admin/detail.html?oid='+ aData[0] +'&otype=4" class="linebtn">查看详情</a>';
            	...
            	$('body').delegate('#filteropt a','click',function(){
                	...
                	$.post('/hospital/delVedio',{vedioId:vedioId},function(d){
                		oTable.draw(false);
                	});
                }).delegate('.changstat','click',function(){
                	var vedioId=$(this).attr('id'),sval=$(this).attr('sval');
                	$.post('/hospital/changVedioStat',{vedioId:vedioId,sval:sval},function(d){
                		oTable.draw(false);
                	});
                });
                $.get('/hospital/gainDistDoctors',{otype:4}).done(function(d){
