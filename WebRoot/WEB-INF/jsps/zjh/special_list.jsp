...
<body>
		...
		<div id="titleTap" class="g_fixed">
			<div class="nav-bar-block">
				<div class="bar-header box">
					<div class="cols1">
						<form action="/wzjh/speciallist" method="get" class="queryform" id="mainform">
							...
							<input type="hidden" value="${cooHosId}" id="cooHosId" name="cooHosId" />
	...
	<div id="citys" class="g_fixed g_dialog">
		...
		<div class="g_content g_fixed">
			...
			<dl class="bodyer1">
				<dd data-id="全部" class="dialist" onclick="javascript:void(0)"><span>全部</span></dd>
    ...
    <script>
		var pageno = 2,totle=0,keywords='${keywords}',isdown = false,_burl = '/',_action = 'specialdetail';
    </script>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$(document).endlessScroll({
				...
				loader:'<p style="text-align:center;"><img src="'+ _b.link +'lib/infinite.scroll/img/ajax-loader.gif" /></p>',
				stop:function(){
					return isdown;
				},
				callback: function(p) {
