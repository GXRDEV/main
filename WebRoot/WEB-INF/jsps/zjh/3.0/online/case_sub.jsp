...
<html>
  ...
  <body class="confirmBody">
    <div class="confirmIndex">
		<form action="/wzjh/subonlineorder" method="post" id="postorder" name="postorder">
			<input type="hidden" name="openid" value="${openid}"/>
	    	<input type="hidden" name="ltype" value="${ltype}"/>
	    	<input type="hidden" name="docid" value="${docid}"/>
	    	<input type="hidden" name="caseid" value=""/>
			<div class="mianinfo blockinfo">
				<div class="weui_cells_title">患者信息</div>
			...
			<div class="baseinfo blockinfo">
				...
				<div class="weui_cells weui_cells_form">
					...
					<div class="weui_cell">
			            <div class="weui_cell_bd weui_cell_primary">
			                <textarea class="weui_textarea" name="presentIll" placeholder="请详细描述您的病情，症状，治疗经过以及需要获得的帮助" rows="5"></textarea>
			...
			<div class="baseinfo blockinfo">
				<div class="weui_cells_title">咨询目的</div>	
				<div class="weui_cells weui_cells_form">		
					<div class="weui_cell">
			            <div class="weui_cell_bd weui_cell_primary">
			                <textarea class="weui_textarea" name="askProblem" placeholder="请详细描述您要咨询的问题" rows="5"></textarea>
			                <!-- <div class="weui_textarea_counter"><span>0</span>/200</div> -->
			            </div>
			        </div>
				</div>
