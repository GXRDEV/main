...
<html>
  <head>
	...
	<style>
		...
		.headTop .btnTop{display:inline-block;color:#EA4844;border:1px solid #EA4844;border-radius:3px;padding:3px 5px;position:absolute;right:0;top:5px;;background-color:#fff;}
    ...
    <div id="index" class="index">
    	<header>
    		<p class="tabs">
				...
				<a href="/wtspz/mycompleteorders.do?openid=${openid}" class="current">已完成</a>
    	...
    	<ul id="orderList">
    		<c:forEach items="${orders}" var="order">
	    		<li class="orderList">
	    			<div class="headTop">
	    				<label>完成时间&ensp;${order.refreshTime}</label>
	    				<a class="btnTop" href="javascript:void(0);" >分享给好友</a>
	    			</div>
	    			<div class="bodyDiv">
	    				<dl>
			...
			_b._post('wtspz/moreorders.do',{openid:_b.oid,flag:_b.flg,pageNo: nextP},function(d){
				...
				d.orders.length ? ($.each(d.orders,function(i,o){
					...
					ops += '<li class="orderList">\
				    			<div class="headTop">\
				    				<label>完成时间&ensp;'+ o.refreshTime +'</label>\
				    				<a class="btnTop" href="javascript:void(0);" >分享给好友</a>\
				    			</div>\
				    			<div class="bodyDiv">\
				    				<dl>\
