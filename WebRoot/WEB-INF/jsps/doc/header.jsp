...
<body>
    <!--Header-part-->
    <div id="header">
      <h1><a href="dashboard.html">医生管理系统</a></h1>
    </div>
    <!--close-Header-part--> 
    ...
    <div id="sidebar">
        <ul>
			...
			<li class="submenu  open">
				...
				<ul>
                    <li class="active"><a class="menu_a" href="/docadmin/experhz" target="iframe-main"><i class="icon icon-caret-right"></i>远程门诊</a></li>
                    <li><a class="menu_a" href="/docadmin/helporder" target="iframe-main"><i class="icon icon-caret-right"></i>辅助下单</a></li>
                    <li><a class="menu_a" href="/docadmin/intospadvice" target="iframe-main"><i class="icon icon-caret-right"></i>专家咨询</a></li>
                    <li><a class="menu_a" href="/docadmin/showadviceorders" target="iframe-main"><i class="icon icon-caret-right"></i>查看回复</a></li>
                </ul>
            </li>
            <!-- <li class="submenu"> 
                <a href="#">
                ...
                <ul>
                    <li><a class="menu_a" link="form-common.html"><i class="icon icon-caret-right"></i>患者管理</a></li>
