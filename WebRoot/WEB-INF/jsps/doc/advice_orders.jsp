 ...
 <script>
            ...
            $(document).ready(function () {            	
            	oTable = $('.data-table').DataTable({
                    ...
                    "sAjaxSource": "/docadmin/gainadviceorders",
                    ...
                    "columns":[
                   		{"visible": false},null,null,null,null,null,null,null,null
                    ],       
					"fnCreatedRow": function (nRow, aData, iDataIndex) {
						var path= '/docadmin/showadvicedetail/' + aData[0];
                        $('td:eq(7)', nRow).html('<a href="'+ path +'" class="editTool">查看详情</a>');
                    },
                    "oLanguage": {
