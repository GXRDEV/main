 ...
 <script>
            ...
            $(document).ready(function () {            	
            	oTable = $('.data-table').DataTable({
                    ...
                    "sAjaxSource": "/docadmin/gainorders",
                    ...
                    "columns":[
                   		{"visible": false},null,null,null,null,null,null,null,null,null,null,null
                    ],       
					"fnCreatedRow": function (nRow, aData, iDataIndex) {
						var path= '/doctor/orderdetail/' + aData[0]+"/1",_val=aData[4],_className = '',_iconfont = '';
						...
						$('td:eq(3)', nRow).html('<span class="hasiconfont"><i class="iconfont">'+ _iconfont +'</i>'+ _val +'</span>');
                        $('td:eq(10)', nRow).html('<a href="'+ path +'" class="editTool">查看详情</a><a href="javascript:void(0);" data-id="'+ aData[0] +'" class="editTool del">删除订单</a>');
                    },
                    "oLanguage": {
