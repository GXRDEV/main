...
<body class="dochelporder">
	<form class="row-fluid form-horizontal"  method="post" id="myform">
			...
			<div class="bodyer">
				...
				<div class="section2 step">
					<div class="editorArea">
						<button type="button" data-moreinfo="true" class="professInfo selected">专业版病例</button>
						<button type="button" data-moreinfo="false" class="simpleInfo">简易版病例</button>
					</div>
					<div class="section baseinfo">					
						...
						<div class="bodyer clearfix fromgroups" style="min-height:auto;">
							<div class="control-group" style="margin:10px;">
							    <textarea name="description" placeholder="请详细描述患者病情信息" style="height: 7em;width: 100%;box-sizing: border-box;"></textarea>
							</div>
						</div>
					</div>
						...
						<div class="bodyer">
							...
							<h3>
								...
								<span class="custombtngroup">
									<button class="btnupload syscase" type="button" style="margin-right:10px;" id="uploadBySelf">手动上传</button>
									<%-- <c:if test="${dockingMode == '2'}">
					...
					<div class="section">
						...
						<div class="bodyer hasmargin clearfix">
							<div id="pics" class="diyUpload">
								...
								<input type="hidden" id="pics_hidden" name="normalImages" value=""/>			
							</div>
						</div>
					</div>
					<div class="section">
					     	...
					     	<div class="customlists">
					     		...
					     		<dl class="initlist">
					     			<c:forEach items="${specials}" var="o">
					     				<dd class="filteDoc" title="${o.displayName }" data-type="hos" data-id="${o.id }">${o.displayName }</dd>
					     			</c:forEach>
					     			<dt><a href="javascript:;" data-ref="/kangxin/gainHospitalsByAddress">更多</a></dt>
					     		</dl>
					     	</div>
					     	<div class="customlists">
					     		<label>按科室：</label>
					     		<dl class="initlist">
					     			<c:forEach items="${deps}" var="o">
					     				<dd class="filteDoc" title="${o.displayName }" data-type="dep" data-id="${o.id }">${o.displayName }</dd>
					     			</c:forEach>
					     			<dt><a href="javascript:;" data-ref="/kangxin/gainStandDeps">更多</a></dt>
					     		</dl>				     		
					     	</div>
				     	</div>
				...
				<div class="section section5 step wxconfirmpay">
				     ...
				     <div class="bodyer clearfix ">						
			 			 ...
			 			 <div class="form-action">
			 			 	<button type="button" class="btn" name="nextstep" data-step="3-1">上一步</button>
			 			 	<button type="button" class="btn btn-primary" name="nextstep" data-step="6">完成支付</button>
			 			 </div>
					</div>
				</div>
				<div class="section section6 step wxsuccesspay">
				     ...
				     <div class="bodyer clearfix ">						
			 			 ...
			 			 <div class="form-action">
			 			 	<button type="button" class="btn" name="nextstep" data-step="-1" data-href="/docadmin/showadviceorders">返回订单列表</button>
			 			 </div>
					</div>
				</div>
			</div>
		...
		<input type="hidden" name="asktype" value="true"/>
	...
	<script type="text/javascript">
		var _burl='/',_href = _burl,_utype = '1',_protag = '1',_h = _burl,_id = '',_orderid,_uuid,_oid = _orderid,_swipers = {};
