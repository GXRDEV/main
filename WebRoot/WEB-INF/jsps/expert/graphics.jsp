	...
	<script>
            ...
            $(document).ready(function () {            	
            	oTable = $('.data-table').DataTable({
                    ...
                    "sAjaxSource": "/expert/gaingraphicorders",
                    "bFilter": true,"bLengthChange": true,"bProcessing": true,   
                    "columns":[
                          		null,null,null,null,null,null,null,null,null
                           ],
					"fnCreatedRow": function (nRow, aData, iDataIndex) {
						var path= '/expert/twdetail/' + aData[0],_val=aData[7];
						var ops='';
						if(_val.indexOf('进行中') != -1){	
							ops='<a href="javascript:void(0);" data-id="'+ aData[0] +'" class="linebtn closetw">取消订单</a>';
						}
                    	$('td:eq(8)', nRow).html('<a href="'+path+'" data-id="'+ aData[0] +'" class="editbtn linebtn">查看详情</a>'+ops);
                    },
                    "oLanguage": {
            	...
            	$('body').delegate('#filteropt a','click',function(){
                	...
                	$.post('/doctor/closetw',{oid:oid,utype:'2'},function(data){
                		oTable.page('first').draw(false);
                	});
                });
