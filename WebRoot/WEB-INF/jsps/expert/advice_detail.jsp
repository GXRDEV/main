		...
		<div class="userinfo">
			<div class="bodyer">				
				...
				<div class="section baseinfo">					
					<div class="header clearfix">
						<span class="span12 stitle">
							<i class="iconfont">&#xe600;</i>咨询目的
						</span>
					</div>
					<div class="bodyer clearfix fromgroups" style="min-height:auto;">
						<div class="control-group" style="margin:10px;">
						    <span class="input">${caseinfo.askProblem }</span>
						</div>
					</div>
				</div>				
						...
						<div class="dialog section divblock">
							...
							<div class="bodyer" id="messageReply">
								<c:forEach items="${msgs }" var="im">													
									...
									<div class="hhlist clearfix<c:if test="${im.sendType != '2' }"> doc</c:if><c:if test="${im.sendType == '2' }"> me</c:if>">								
	...
	<script type="text/javascript">
		$(function(){
			$("#reply").click(function(){
				...
				$.post("/expert/replytodoc",{oid:_oid,msgContent:t},function(data){
