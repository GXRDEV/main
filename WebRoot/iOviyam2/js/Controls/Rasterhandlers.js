 ...
 var seletedradios=function getSelectedRadio(){
   ...
   // alert("......checked values in   date picker ........"+radioV);
    ...
    if(radioV=='4'){
        ...
        //  alert("........"+subbed.getHours()+":"+subbed.getMinutes()+"..."+hour+":"+mnts);
        localStorage.setItem("localfromdate", today); 
        localStorage.setItem("localtodate", today);
    ...
    if(radioV=='5'){
        ...
        //  alert("........"+subbedfour.getHours()+":"+subbedfour.getMinutes()+"..."+hour+":"+mnts);
        localStorage.setItem("localfromdate",today); 
        localStorage.setItem("localtodate",today);
    ...
    if(radioV=='6'){
        ...
        // alert("....."+day+"/"+month+"/"+year+"..last week."+lastweek.getDate()+"/"+(lastweek.getMonth()+1)+"/"+lastweek.getFullYear());
        localStorage.setItem("localfromdate", today); 
    ...
    if(radioV=='7'){
        ...
        //alert("....."+day+"/"+month+"/"+year+"..last week."+lastweekdate.getDate()+"/"+(lastweekdate.getMonth()+1)+"/"+lastweekdate.getFullYear());
        localStorage.setItem("localfromdate", today); 
    ...
    if(radioV=='8'){
        ...
        //  alert("....."+day+"/"+month+"/"+year+"..last week."+lastmonthdate.getDate()+"/"+(lastmonthdate.getMonth()+1)+"/"+lastmonthdate.getFullYear());
        localStorage.setItem("localfromdate",today); 
