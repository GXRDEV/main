			...
			$(window).scroll(function(){
				...
				if ($(document).height() - $(window).height() <= $(window).scrollTop() + options.bottomPixels)
				{
					if ((options.fireOnce == false || (options.fireOnce == true && fired != true)))
					{
						...
						$(options.insertAfter).after('<div id="endless_scroll_loader" style="position:fixed;bottom:0;left:0;right:0;background-color:#eee;opacity:0.85;padding:6px 0;">' + options.loader + '</div>');
