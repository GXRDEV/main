...
@Entity
@Table(name="business_d2p_consultation_request")
public class BusinessD2pConsultationRequest implements Serializable{
	private static final long serialVersionUID = -6654615749145510593L;
	@Id
